...
This script runs scenario B of LCA2 100 times.
...
dna_file_name = '4_LCA2_scenarioB'                     # Name of the DNA file (without .dna!)
dna_path = os.path.join(dir_path, dna_file_name)       # Path of the DNA file

airsim_settings_file_name = '4_LCA2_scenarioB.json'    # Name of the AirSim settings .json
